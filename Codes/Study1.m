...
simple_model_study1 = fitlme(Table_data_study1, 'Rate ~ 1 + Runs_mean_centered + Trials_mean_centered + Biological_Sex + Stimulus_Intensity *  Intensity_Offer_mean_centered * Montary_Offer_mean_centered + (1 +  Intensity_Offer_mean_centered + Montary_Offer_mean_centered + Stimulus_Intensity | Sub)','StartMethod','random');
anova_simple_model_study1 = anova(simple_model_study1,'dfmethod','satterthwaite');



complex_model_study1 = fitlme(Table_data_study1, 'Rate ~ 1 + Runs_mean_centered * Trials_mean_centered + Biological_Sex + Stimulus_Intensity *  Intensity_Offer_mean_centered * Montary_Offer_mean_centered + (1 + Runs_mean_centered * Trials_mean_centered + Intensity_Offer_mean_centered * Montary_Offer_mean_centered * Stimulus_Intensity | Sub)','StartMethod','random');
anova_complex_model_study1 = anova(complex_model_study1,'dfmethod','satterthwaite');
...
h = daviolinplot(X_study1, 'outsymbol','k+','violin', 'half2', 'violinwidth', 3, 'boxcolors','same',...
